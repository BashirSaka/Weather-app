...
export default function SettingsModal({ settings, onApply, onClose }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-start justify-center pt-16 bg-black/50 backdrop-blur-sm overflow-y-auto">
      <div className="w-full max-w-sm mx-4 mb-16 p-4 rounded-2xl bg-white/95 dark:bg-slate-900/90 backdrop-blur-xl border border-slate-300/50 dark:border-white/20 shadow-xl">
